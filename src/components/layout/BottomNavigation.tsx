import { CalendarDays, CalendarRange, Calendar, Target, Layers } from 'lucide-react'
      ...
      {tabs.map(({ id, label, icon: Icon }) => {
        ...
        return (
          <button
            ...
            className="flex-1 flex flex-col items-center justify-center gap-0.5 py-2 min-h-14 active:bg-white/5 transition-colors"
